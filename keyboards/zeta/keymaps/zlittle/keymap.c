	 ...
	 */
	 [BASE] = LAYOUT_ortho_4x12 (
	    ...
	    MT(MOD_LGUI, KC_BSPC),  KC_A,  KC_S,   KC_D,   KC_F, KC_G,                 							 KC_H,    KC_J, KC_K, KC_L,   KC_SCLN, KC_QUOT,
	     ...
	     KC_LSFT,LGUI(LCTL(KC_Q)),LT(SYMB, KC_SPC),KC_ESC, MT(MOD_LCTL, KC_DEL), LT(SYMB, KC_SPC),         	LT(NUMB, KC_SPC),	  KC_LSFT, KC_TAB,LCTL(LSFT(KC_3)),LT(NUMB, KC_SPC),LCTL(LSFT(KC_4))
	     ),
...
[NUMB] = LAYOUT_ortho_4x12 (
    ...
    [ONE_HAND] = LAYOUT_ortho_4x12 (
         ...
         *                                 `-------                             `--------
         */
        [ONE_HAND_ALT] = LAYOUT_ortho_4x12 (
